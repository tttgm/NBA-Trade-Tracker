...
nba_matrix <- as.matrix(nba_df)
chorddiag(nba_matrix, showTicks = F, groupnameFontsize = 12, groupnamePadding = 5) #, type = "directional", showTicks = F, groupnameFontsize = 14, groupnamePadding = 10, margin = 90)
```
